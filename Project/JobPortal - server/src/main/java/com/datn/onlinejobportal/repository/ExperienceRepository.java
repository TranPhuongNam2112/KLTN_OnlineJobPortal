...
public interface ExperienceRepository extends JpaRepository<Experience, Long> {
	...
	@Query("Select new com.datn.onlinejobportal.payload.ExperienceResponse(e.id, e.company_name, e.job_title, e.start_date, e.end_date, e.description) "
			+ "From Experience e LEFT JOIN e.candidate c LEFT JOIN c.user u Where u.id = :userId And e.id = :experienceId")
